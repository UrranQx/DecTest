...
fun feeRatio(taxes: String, money: Int): Double {
    ...
    // кстати, это решение работает только в том, случае, когда у нас суммы налогов заданы по возрастанию
    // иначе пришлось бы создавать hashTable записывать туда соответствующие значения,
    // сортировать по ключу
    // переделывать в тот вид двух листов (line 69; line 70)
}
